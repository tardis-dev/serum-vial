...
// L2ORderBook
// obsluguje robienie diffow tez!!
// export class OrderBook {
//   private readonly _bids = new RBTree<BookPriceLevel>((nodeA, nodeB) => nodeB[0] - nodeA[0])
//   private readonly _asks = new RBTree<BookPriceLevel>((nodeA, nodeB) => nodeA[0] - nodeB[0])
